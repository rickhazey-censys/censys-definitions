...
_PROTOCOL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_KUBERNETES', index=34, number=127,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_MEMCACHED', index=35, number=128,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_REDIS', index=36, number=129,
      options=None,
      type=None),
  ],
