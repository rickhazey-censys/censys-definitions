...
_PROTOCOL = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_MONGO', index=28, number=64,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_MSSQL', index=29, number=65,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_MYSQL', index=30, number=66,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_ORACLE', index=31, number=67,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_POSTGRES', index=32, number=68,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_MEMCACHED', index=33, number=128,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROTO_REDIS', index=34, number=129,
      options=None,
      type=None),
  ],
