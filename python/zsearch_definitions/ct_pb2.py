...
_CTSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='startssl_ct', full_name='zsearch.CTStatus.startssl_ct', index=33,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wotrus_ctlog', full_name='zsearch.CTStatus.wotrus_ctlog', index=34,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wotrus_ctlog3', full_name='zsearch.CTStatus.wotrus_ctlog3', index=35,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gdca_ct', full_name='zsearch.CTStatus.gdca_ct', index=36,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gdca_ctlog', full_name='zsearch.CTStatus.gdca_ctlog', index=37,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gdca_log', full_name='zsearch.CTStatus.gdca_log', index=38,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gdca_log2', full_name='zsearch.CTStatus.gdca_log2', index=39,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='venafi_api_ctlog', full_name='zsearch.CTStatus.venafi_api_ctlog', index=40,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='venafi_api_ctlog_gen2', full_name='zsearch.CTStatus.venafi_api_ctlog_gen2', index=41,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='nordu_ct_plausible', full_name='zsearch.CTStatus.nordu_ct_plausible', index=42,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='letsencrypt_ct_clicky', full_name='zsearch.CTStatus.letsencrypt_ct_clicky', index=43,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cnnic_ctserver', full_name='zsearch.CTStatus.cnnic_ctserver', index=44,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='certly_log', full_name='zsearch.CTStatus.certly_log', index=45,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sheca_ct', full_name='zsearch.CTStatus.sheca_ct', index=46,
