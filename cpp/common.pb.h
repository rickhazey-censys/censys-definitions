...
class UserdataAtom : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:zsearch.UserdataAtom) */ {
 public:
  ...
  #if LANG_CXX11
  void set_private_tags(int index, ::std::string&& value);
  #endif
  ...
  #if LANG_CXX11
  void add_private_tags(::std::string&& value);
  #endif
  ...
  #if LANG_CXX11
  void set_public_tags(int index, ::std::string&& value);
  #endif
  ...
  #if LANG_CXX11
  void add_public_tags(::std::string&& value);
  #endif
...
#if LANG_CXX11
inline void UserdataAtom::set_private_tags(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:zsearch.UserdataAtom.private_tags)
...
#if LANG_CXX11
inline void UserdataAtom::add_private_tags(::std::string&& value) {
...
#if LANG_CXX11
inline void UserdataAtom::set_public_tags(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:zsearch.UserdataAtom.public_tags)
...
#if LANG_CXX11
inline void UserdataAtom::add_public_tags(::std::string&& value) {
