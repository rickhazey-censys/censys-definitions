...
func (*MinScanId) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*MozillaOneCRLEntry) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*Command) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*AnonymousStoreStatistics) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*StatisticsPair) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*StoreStatistics) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func (*ServerStatistics) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{6} }
...
func (*PruneStatistics) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{7} }
...
func (*CommandReply) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{8} }
...
func (*HostQuery) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{9} }
...
func (*HostQueryResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{10} }
...
func (*AnonymousQuery) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{11} }
...
func (*AnonymousQueryResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{12} }
...
func (*UserDataRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{13} }
...
func (*RootStoreQuery) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{14} }
...
func (*RootStoreReply) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{15} }
